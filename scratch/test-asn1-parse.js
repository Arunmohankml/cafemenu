...
// The OCTET STRING starts at byte 26.
// Let's print the hex bytes starting from byte 26
const rsaKeyBuffer = buffer.slice(26);
console.log("RSAPrivateKey start (hex):", rsaKeyBuffer.slice(0, 30).toString('hex'));
